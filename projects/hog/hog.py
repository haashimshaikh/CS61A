...
def boar_brawl(player_score, opponent_score):
    ...
    difference = abs(opponent_tens_digit - player_ones_digit)
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    initial_score = simple_update(num_rolls, player_score, opponent_score, dice)
    return sus_points(initial_score)
